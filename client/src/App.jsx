...
function App() {
  const TwitterContractAddress = "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512";
    ...
    <>
      <div className="bg-black  max-h-screen w-full p-0 m-0 text-white font-sans flex flex-col ">
        <nav className="h-24 w-full bg-gray-100 flex  justify-between  items-center p-4  px-10 ">
          ...
          ></img> */}
          <h1 className=" text-center text-cyan-600 font-extrabold text-2xl">
            Twitter
          </h1>
        ...
        <div className="h-screen w-full bg-[#0f0a15]">
        ...
        <div className="h-screen w-full bg-[#17151a]">
          <div className="container mx-auto p-4">
            <h2 className="text-2xl font-bold mb-4 text-white">MyPosts</h2>
            <ul className="grid grid-cols-1 gap-4">
              {myTweets.map((tweet) => (
                <li key={tweet.id} className="p-4 bg-white shadow rounded-lg">
